...
class Player:
    def __init__(self, x, y):
        ...
        self.visible = True
        self.img = pygame.transform.scale(pygame.image.load("Pygame-All-Projects/Top-Down-Tank-Game/assets/images/Tanks.png"), (64, 64))
        self.dirn = 0

#----------Cannon----------#
        self.cannon_img = pygame.transform.scale(pygame.image.load("Pygame-All-Projects/Top-Down-Tank-Game/assets/images/cannon.png"), (50, 50))
