...
mixer.music.load("Rock-Paper-Scissors/assets/sound.mp3")
mixer.music.set_volume(0.9)

pygame.display.set_caption("Rock-Paper-Scissors!")

def get_image(name):
    return pygame.transform.scale(pygame.image.load(join("Rock-Paper-Scissors/assets", name)), (192, 192))
...
class App:
    def __init__(self):
        ...
        self.font = pygame.font.Font("Rock-Paper-Scissors/assets/brightgear.otf", 48)
