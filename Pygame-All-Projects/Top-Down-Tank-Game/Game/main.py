...
class Main:
    def __init__(self):
        ...
        self.tank_shooting = pygame.mixer.Sound("Top-Down-Tank-Game/assets/sounds/tank-shooting.wav")
        self.tank_hit = pygame.mixer.Sound("Top-Down-Tank-Game/assets/sounds/tank-hit.mp3")
